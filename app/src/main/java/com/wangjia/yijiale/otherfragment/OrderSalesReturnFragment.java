 ...
 * 已完成
 */
public class OrderSalesReturnFragment extends Fragment implements MyOrderActivityView {
    ...
    public void initData() {
        myOrderActivityPresenter.getData(YiApplication.getInstance().getToken(), 40, 1);
