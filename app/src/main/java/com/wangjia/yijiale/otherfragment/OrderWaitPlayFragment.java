 ...
 * 待发货
 */
public class OrderWaitPlayFragment extends Fragment implements MyOrderActivityView {
                ...
                .subscribe(new Action1<StatusBarEvent>() {
                    ...
                    public void call(StatusBarEvent statusBarEvent) {
                        if (statusBarEvent.getName().equals("Update_data")) {
                            //更新数据
                            myOrderActivityPresenter.getData(YiApplication.getInstance().getToken(), 20, 1);
                        }
                    }
                });
    }
