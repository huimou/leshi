...
public class CycleView extends LinearLayout {
    ...
    private void setItems(List<Images> imgs, FragmentManager fragmentManager, OnItemClickListener listener) {
        ...
        CycleViewStatePagerAdapter cycleViewStatePagerAdapter = new CycleViewStatePagerAdapter(this.getContext(), fragmentManager, imgs, listener, ViewPagerItemFragment.scaleType.fitXY);
