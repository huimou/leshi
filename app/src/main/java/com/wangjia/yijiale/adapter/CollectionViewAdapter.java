 ...
 * on 2015/7/2.
 */
public class CollectionViewAdapter extends RecyclerView.Adapter<CollectionViewAdapter.MyViewHolder> implements SlidingButtonView.IonSlidingButtonListener {

    private LayoutInflater minflater;
    private Context mContext;
    protected CollectionList mDatas;
    private List<String> choses;
    //private IonSlidingViewClickListener mIDeleteBtnClickListener;
    private SlidingButtonView mMenu = null;
    boolean allopen = false;

    public void setDatas(CollectionList mDatas) {
        this.mDatas = mDatas;
        notifyDataSetChanged();
    }

    public interface OnItemClickListener {
        void onItemClick(View view, int postion, CollectionList.DatasBean.FavoritesListBean bean);

        void onItemLongClick(View view, int postion);

        void onDeleteBtnCilck(View v, int layoutPostion, CollectionList.DatasBean.FavoritesListBean bean);
    }
    ...
    public CollectionViewAdapter(Context context, CollectionList datas) {
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, final int i) {
        myViewHolder.slidingButtonView.setSlidingButtonListener(CollectionViewAdapter.this);
        //设置内容布局的宽为屏幕宽度
