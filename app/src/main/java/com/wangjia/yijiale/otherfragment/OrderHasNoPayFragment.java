 ...
 * 待付款
 */
public class OrderHasNoPayFragment extends Fragment implements MyOrderActivityView {
    ...
    public void initData() {
        myOrderActivityPresenter.getData(YiApplication.getInstance().getToken(), 10, 1);
